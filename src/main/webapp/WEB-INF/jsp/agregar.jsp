...
<div class="container">
    ...
    <form action="${urlAgregar}" modelAttribute="empleadoFormulario" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="deparatamento" class="form-label">Departamento</label>
            <input type="text" class="form-control" id="deparatamento"
                   name="departamento">
        </div>
        <div class="mb-3">
