package co.co.zonatelematica.empleados.controlador;

import co.co.zonatelematica.empleados.modelo.Empleado;
import co.co.zonatelematica.empleados.servicio.EmpleadoServicio;
...
public class IndexControlador {
    ...
    public String iniciar(ModelMap modelo){
        ...
        //Se compoarte el modelo con la vista
    ...
    public String agregar(@ModelAttribute("empleadoFormulario")Empleado empleado){
    ...
    public String editar(@ModelAttribute("empleadoFormulario")Empleado empleado){
